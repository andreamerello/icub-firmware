...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(MOT3_ENCB_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MOT3_ENCZ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM5;
    HAL_GPIO_Init(MOT3_ENCZ_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MOT3_ENCA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(MOT3_ENCZ_GPIO_Port, MOT3_ENCZ_Pin);

    HAL_GPIO_DeInit(MOT3_ENCA_GPIO_Port, MOT3_ENCA_Pin);
